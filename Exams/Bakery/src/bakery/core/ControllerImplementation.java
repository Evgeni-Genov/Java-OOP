...
public class ControllerImplementation implements Controller {
    ...
    public ControllerImplementation(FoodRepository<BakedFood> foodRepository,
    ...
    public String addFood(String type, String name, double price) {
        BakedFood existing = this.foodRepository
                .getAll()
                .stream()
    ...
    public String addDrink(String type, String name, int portion, String brand) {
        Drink existing = this.drinkRepository
                .getAll()
                .stream()
    ...
    public String addTable(String type, int tableNumber, int capacity) {
        Table existing = this.tableRepository
                .getAll()
                .stream().filter(t -> t.getTableNumber() == tableNumber)
                .findFirst()
                .orElse(null);
    ...
    public String orderDrink(int tableNumber, String drinkName, String drinkBrand) {
        ...
        return String.format(DRINK_ORDER_SUCCESSFUL,
