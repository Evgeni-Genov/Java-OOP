...
import CounterStriker.models.field.FieldImplementation;
...
public class ControllerImplementation implements Controller {
    ...
    public ControllerImplementation() {
        ...
        this.field = new FieldImplementation();
    }
    ...
    public String report() {
        ...
        this.players.getModels().stream()
                .sorted((p1, p2) -> {
                    int result = p1.getClass()
                            .getSimpleName()
                            .compareTo(p2.getClass()
                                    .getSimpleName());

                    if (result == 0) {
                        result = Integer.compare(
                                p2.getHealth(), p1.getHealth());
                    }

                    if (result == 0) {
                        result = p1.getUsername()
                                .compareTo(p2.getUsername());
                    }

                    return result;
                })
                .forEach(p -> builder.append(p.toString())
