...
public class EngineImplementation implements Engine {
    ...
    public EngineImplementation() {
        this.controller = new ControllerImplementation();
         ...
         switch (command) {
            case AddComputer:
                return this.controller
                        .addComputer(data[0], Integer.parseInt(data[1]), data[2], data[3], Double.parseDouble(data[4]));

            case AddPeripheral:
                return this.controller
                        .addPeripheral(Integer.parseInt(data[0]),
                ...
                return this.controller
                        .removePeripheral(data[0], Integer.parseInt(data[1]));

                case AddComponent:
                return this.controller
                        .addComponent(Integer.parseInt(data[0]),
                                Integer.parseInt(data[1]), data[2],
                                data[3], data[4],
                                Double.parseDouble(data[5]),
                ...
                return this.controller
                        .removeComponent(data[0], Integer.parseInt(data[1]));

                case BuyComputer:
                return this.controller
                        .buyComputer(Integer.parseInt(data[0]));

                case BuyBestComputer:
                return this.controller
                        .BuyBestComputer(Double.parseDouble(data[0]));

                case GetComputerData:
                return controller
                        .getComputerData(Integer.parseInt(data[0]));
