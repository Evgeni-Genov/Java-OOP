...
public interface Controller {
    ...
    String addPeripheral(int computerId, int id, String peripheralType, String manufacturer,
    ...
    String addComponent(int computerId, int id, String componentType, String manufacturer,
