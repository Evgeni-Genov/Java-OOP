...
public class Bag {
    ...
    private boolean isEnoughCapacity(long quantity) {
        return this.totalCash + this.totalGems + this.totalGold
    ...
    public String toString() {
        ...
        if (isGoldAdded) {
            sb.append(String.format("<Gold> $%d", this.totalGold))
                    .append(System.lineSeparator())
                    .append(String.format("##Gold - %d", this.totalGold))
                    .append(System.lineSeparator());

        }

        if (this.gems.size() > 0) {
            sb.append(String.format("<Gem> $%d", this.totalGems))
                    .append(System.lineSeparator());
        ...
        if (this.cash.size() > 0) {
            sb.append(String.format("<Cash> $%d", this.totalCash))
                    .append(System.lineSeparator());
